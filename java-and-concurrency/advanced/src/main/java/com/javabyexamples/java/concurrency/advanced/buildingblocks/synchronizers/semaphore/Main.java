package com.javabyexamples.java.concurrency.advanced.buildingblocks.synchronizers.semaphore;
...
public class Main {
    ...
    public void run(List<Integer> list, int capacity) throws InterruptedException {
        BoundedListWithSemaphore<Integer> boundedList = new BoundedListWithSemaphore<>(list, capacity);
