...
import com.javabyexamples.java.concurrency.advanced.common.annotation.ThreadConfined;
...
public class CompletionServiceTest {
    ...
    @ThreadConfined
    private ThreadLocal<Random> random = new ThreadLocal<>().withInitial(Random::new);
